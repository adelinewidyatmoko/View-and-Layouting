...
private $index = 
  [
    ...
    [
      ...
      'short_desc' => "Timeless lessons on wealth, greed, and happiness doing well with money isn’t necessarily about what you know. It’s about how you behave. And behavior is hard to teach, even to really smart people."
    ],
    [
      'id' => 11, 
      'image' => 'https://covers.openlibrary.org/b/olid/OL29191495M-M.jpg', 
      'title' => "Ugly Love", 
      'short_desc' => "ATTRACTION AT FIRST SIGHT CAN BE MESSY… When Tate Collins finds airline pilot Miles Archer passed out in front of her apartment door, it is definitely not love at first sight."
    ],
    [
      'id' => 12, 
      'image' => 'https://covers.openlibrary.org/b/olid/OL26425330M-M.jpg', 
      'title' => "A Game of Thrones", 
      'short_desc' => "A Game of Thrones is the first novel in A Song of Ice and Fire, a series of fantasy novels by the American author George R. R. Martin. It was first published on August 1, 1996."
    ]
  ];

  public function indexs()
  {
    return view('book')->with('index',$this->index);
  }
    
 public function detail() /*setiap buat page baru atau file baru, maka buat controller untuk bisa viewin kayak gini contohny*/
 {
  return view('detail'/*ini maksud detail itu nama dari file views nya ya.. di folder view aku kasi nama detail.blade.php maka jadi 'detaiil'*/)->with('index', $this->index);
 }
}
